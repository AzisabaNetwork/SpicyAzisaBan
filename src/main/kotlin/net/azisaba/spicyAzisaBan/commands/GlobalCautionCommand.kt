...
object GlobalCautionCommand: Command("${SABConfig.prefix}gcaution"), TabExecutor {
    ...
    override fun execute(sender: CommandSender, args: Array<String>) {
        ...
        if (args.isEmpty()) return sender.send(SABMessages.Commands.Caution.globalUsage.replaceVariables().translate())
        val arguments = ArgumentParser(args.joinToString(" "))
        Promise.create<Unit> { context ->
            CautionCommand.doCaution(sender, arguments)
            context.resolve()
        }.catch {
