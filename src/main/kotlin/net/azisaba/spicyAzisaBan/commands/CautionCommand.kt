...
object CautionCommand: Command("${SABConfig.prefix}caution"), TabExecutor {
    ...
    internal fun doCaution(sender: CommandSender, arguments: ArgumentParser) {
    ...
    override fun onTabComplete(sender: CommandSender, args: Array<String>): Iterable<String> {
        ...
        if (s.startsWith("reason=")) return ReasonContext.tabComplete(PunishmentType.CAUTION, args, sender.getServerName())
        return emptyList()
    }
}
