...
object IPBanCommand: Command("ipban"), TabExecutor {
    ...
    override fun execute(sender: CommandSender, args: Array<String>) {
        ...
        Promise.create<Unit> { context ->
            ...
            val p = Punishment
                .createByIPAddress(ip, reason.text, sender.uniqueId, PunishmentType.IP_BAN, -1, server.name)
                .insert()
                .thenDo {
                ...
                .catch {
                    ...
                    SpicyAzisaBan.instance.logger.warning("Something went wrong while handling /ipban from ${sender.name}!")
                    it.printStackTrace()
                }
