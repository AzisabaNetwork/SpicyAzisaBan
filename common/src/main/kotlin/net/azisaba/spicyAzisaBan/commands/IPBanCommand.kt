...
object IPBanCommand: Command() {
    ...
    internal fun doIPBan(actor: Actor, arguments: ArgumentParser) {
        ...
        val p = Punishment
            .createByIPAddress(ip, reason.text, actor.uniqueId, PunishmentType.IP_BAN, -1, server.name)
            .insert(actor)
            .catch {
